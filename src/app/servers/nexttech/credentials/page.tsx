...
export default async function NextTechCredentialsPage() {
  let credentials: any = {};
      ...
      <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-700">
        <div>
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-1">
            <Link href="/servers/nexttech" className="hover:text-white transition-colors">
              NextTech
            </Link>
            <span>/</span>
            <span className="text-white">Credentials</span>
          </div>
          <h2 className="text-2xl font-semibold text-white">NextTech Credentials</h2>
          <p className="text-gray-400 text-sm">
            API keys and authentication for tech operations
          </p>
        </div>
      </div>
