...
export const STUDIO_SERVICES: StudioService[] = [
  // Pipeline Group
  { id: 'user-pc', label: 'User PC', type: 'pc_emitter', group: 'pipeline', description: 'Dump Emitter' },
  ...
  { id: 'router-9500', label: 'Ingest Router', type: 'hub', group: 'pipeline', port: 9500, healthEndpoint: '/health', pm2Name: 'transcripts-9500', description: 'Ingest Hub' },
  { id: 'dashboard-5500', label: 'Dashboard', type: 'ui', group: 'pipeline', port: 5500, pm2Name: 'kodiack-dashboard-5500', description: 'UI Context' },
  { id: 'gateway-7000', label: 'Auth Gateway', type: 'gateway', group: 'pipeline', port: 7000, healthEndpoint: '/health', pm2Name: 'dev-auth-7000', description: 'Auth Gateway' },

  // AI Team Group (in order 01-08)
